@echo off
REM Build script for Hexapod VoiceBot (COM4) - ESP32-S3
echo ========================================================
echo Building Hexapod VoiceBot firmware...
echo ========================================================
...
echo ========================================================
echo Build complete for VoiceBot!
echo Flash with: idf.py -p COM4 flash
echo ========================================================
pause
